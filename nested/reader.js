...
class Reader {
    ...
    async open(file) {
        ...
        this.view.renderer.setAttribute('margin', '12px')
        this.view.renderer.setAttribute('gap', '5%')
        ...
        console.log(this.view.getSectionFractions())
        ...
        document.addEventListener("wheel", ({deltaY}) => {
            ...
            delayReg = setTimeout(this.#handleScrollWheel.bind(this, deltaY), 200);
        });
    ...
    #handleScrollWheel(deltaY) {
        if (deltaY > 0) this.view.goRight();
        else if (deltaY < 0) this.view.goLeft();
    }
